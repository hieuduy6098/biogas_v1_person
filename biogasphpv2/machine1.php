...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
      <div class="mx-3" style="color: white;">Nam Dinh</div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g01status"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g01Energy"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g01Power"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g01Vab"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g01Ia"></div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
            ...
            <div class="col-xl-8 col-md-8 mb-8 col2">
              <div class="row row1">
                <button class="btn btn-sm btn-primary " id="reload" value="g01elepah">Tải lại</button>
              ...
              <hr class="sidebar-divider ">
              <div class="row row2">
                <button class="btn btn-sm btn-primary" id="btnForMonth" value="g01eleeda">Tháng</button>
                <button class="btn btn-sm btn-primary mx-2" id="btnForYear" value="g01eleemo">Năm</button>
                <div class="chart-area" style="height: auto">
