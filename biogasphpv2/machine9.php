  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center">
        <div class="sidebar-brand-text mx-3">Máy 9</div>
      </a>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g09status"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g09Energy"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g09Power"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g09Vab"></div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" id="g09Ia"></div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
            ...
            <div class="col-xl-8 col-md-8 mb-8 col2">
              <div class="row row1">
                <button class="btn btn-sm btn-primary " id="reload" value="g09elepah">Tải lại</button>
              ...
              <hr class="sidebar-divider ">
              <div class="row row2">
                <button class="btn btn-sm btn-primary" id="btnForMonth" value="g09eleeda">Tháng</button>
                <button class="btn btn-sm btn-primary mx-2" id="btnForYear" value="g09eleemo">Năm</button>
                <div class="chart-area" style="height: auto">
